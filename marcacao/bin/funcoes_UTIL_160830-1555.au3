...
func PosicaoXY($buscarTela)
   Local $hWnd = WinWait($buscarTela, "", 10)
   WinActivate($hWnd)
...
func createLog()
	...
	Local $hFileOpen = FileOpen(@ScriptDir&"\log.txt", $FO_APPEND + $FO_CREATEPATH)
